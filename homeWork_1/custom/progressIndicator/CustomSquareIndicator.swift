...
class CustomSquareIndicator: UIActivityIndicatorView {
    ...
    override func startAnimating() {
        self.backgroundColor = UIColor.CustomSquareIndicator.background
        
        myLayer.path = nil
        myLayer.lineWidth = 4
        
        myLayer.strokeColor = UIColor.CustomSquareIndicator.stroke
        myLayer.fillColor = UIColor.CustomSquareIndicator.fill
